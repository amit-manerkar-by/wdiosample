...
const wdiohelper = require('./test/support/wdiohelper.js')
...
const drivers = {
  ...
  chromiumedge: { version: '87.0.664.52' },
}
...
exports.config = {
  ...
  before: function (capabilities, specs) {
    ...
    Object.keys(wdiohelper).forEach((key) => {
      browser.addCommand(key, wdiohelper[key])
    })
  },
  /**
